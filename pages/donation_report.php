    ...
    if (isset($_GET['user_id']))
    {
        ...
        $sql="
            SELECT
                ...
                SUM(o.amt) AS total_plates_bought,
                SUM(o.amt * p.cost) AS total_value
            FROM orders o
...
<head>
    <meta charset="UTF-8">
    <title>Donation Report For Donors</title>
    <style>
        body{
...
<body>
    <h1>Donation Report for Donors</h1>
    ...
    <?php if ($report && $results->num_rows>0):?>
        ...
        <table>
            ...
            <tr><th>Total Paid</th><td><?php echo $report['total_value']?></td></tr>
        </table>
    <?php else:?>
