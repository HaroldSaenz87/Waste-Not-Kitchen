...
$donationQuery = "SELECT p.description, p.cost, d.amt, d.donated_at, r.restaurant_name
                  FROM donations d
...
$stmt = mysqli_prepare($conn, $donationQuery);
...
<body class="donor">
    <div class="navigation">
        ...
        <h1 id="reservation">My Donations</h1>
        ...
        <?php if(mysqli_num_rows($result) > 0): ?>
            <?php while($row = mysqli_fetch_assoc($result)): ?>
                ...
                <?php
                $formatDate = date("M j, Y g:i A", strtotime($row['donated_at']));
                ?>
